...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2022 at 11:07 AM
...
INSERT INTO `booking` (`B_id`, `Seat_No`, `Date`, `Train_id`, `P_id`) VALUES
(2812, 34, '2019-04-01', 23901, 5039),
(3479, 65, '2021-07-29', 23901, 7360),
(6231, 47, '2021-11-29', 74238, 1803),
(7820, 15, '2020-03-09', 82902, 5039),
(7835, 7, '2021-01-25', 42315, 9101),
(7947, 23, '2022-01-11', 100, 3),
(7949, 49, '2022-01-12', 100, 9103);
...
(100, 'Amaravathi', 'KSD', 'MNGLR', 1000, 0),
...
--
ALTER TABLE `booking`
  MODIFY `B_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7951;

--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
  MODIFY `P_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9106;
